...
public class Server
{
    ...
    /// <summary>
    /// Availability zone for HA/DR placement (e.g., "us-east-1a", "eu-west-1b").
    /// Used for spreading replicas across availability zones.
    /// Auto-detected from cloud provider metadata or manually configured.
    /// When set, node is automatically labeled with "zone=<value>" in Swarm.
    /// </summary>
    public string? AvailabilityZone { get; set; }

    /// <summary>
    /// Datacenter or region identifier (e.g., "aws", "onprem", "azure").
    /// Used for geo-distributed HA placement strategies.
    /// When set, node is automatically labeled with "datacenter=<value>" in Swarm.
    /// </summary>
    ...
    /// <summary>
    /// Whether this server was added through the HA Setup Wizard
    /// </summary>
    public bool IsWizardSetup { get; set; }

    /// <summary>
    /// Current wizard step (1-4), null if not in wizard or completed
    /// </summary>
    public int? WizardStep { get; set; }

    /// <summary>
    /// When the HA wizard setup was completed for this server
    /// </summary>
