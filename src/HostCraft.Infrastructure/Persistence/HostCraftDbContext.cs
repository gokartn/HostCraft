...
public class HostCraftDbContext : DbContext
{
    ...
    public DbSet<ComposeEnvironmentVariable> ComposeEnvironmentVariables => Set<ComposeEnvironmentVariable>();
    public DbSet<DatabaseTemplate> DatabaseTemplates => Set<DatabaseTemplate>();
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        ConfigureComposeEnvironmentVariable(modelBuilder);
        ConfigureDatabaseTemplate(modelBuilder);
    }
    ...
    private void ConfigureServer(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Server>(entity =>
        {
            ...
            // Unique constraint on (Host, Port) to prevent duplicate servers
    ...
    private void ConfigureApplication(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Application>(entity =>
        {
            ...
            entity.Property(e => e.Name).IsRequired().HasMaxLength(100);
            entity.Property(e => e.RegistryServer).HasMaxLength(255);
            entity.Property(e => e.RegistryUsername).HasMaxLength(255);
            entity.Property(e => e.RegistryPassword).HasConversion<EncryptedStringConverter>();
            entity.Property(e => e.UsePrivateRegistry).HasDefaultValue(false);
            entity.Property(e => e.CreatedAt).HasDefaultValueSql("CURRENT_TIMESTAMP");
            
            entity.HasIndex(e => e.Uuid).IsUnique();
            entity.HasIndex(e => new { e.ServerId, e.Name }).IsUnique();
            entity.HasIndex(e => new { e.ServerId, e.PublishedPort })
                .IsUnique()
    ...
    private void ConfigureDeployment(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<DeploymentLog>(entity =>
        {
            ...
            entity.HasIndex(e => e.DeploymentId);
                    entity.HasIndex(e => new { e.DeploymentId, e.Timestamp });
    ...
    private void ConfigureBackup(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Backup>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.ApplicationId, e.Status, e.StartedAt });
    ...
    private void ConfigureHealthCheck(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<HealthCheck>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.ApplicationId, e.CheckedAt });
    ...
    private void ConfigureSystemSettings(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<SystemSettings>(entity =>
        {
            ...
            // Note: Let's Encrypt email is NOT encrypted - it's public information
            // (visible in certificate transparency logs)
        });
    }
    ...
    private void ConfigureDomain(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Domain>(entity =>
        {
            ...
            entity.Property(e => e.Uuid).HasDefaultValueSql("gen_random_uuid()");
            entity.Property(e => e.Host).IsRequired().HasMaxLength(255);
            entity.Property(e => e.Path).HasMaxLength(255).HasDefaultValue("/");
            entity.Property(e => e.CertificateType).HasMaxLength(50).HasDefaultValue("letsencrypt");
            entity.Property(e => e.DnsStatus).HasMaxLength(50).HasDefaultValue("pending");
            entity.Property(e => e.CreatedAt).HasDefaultValueSql("CURRENT_TIMESTAMP");

            entity.HasIndex(e => e.Uuid).IsUnique();
            entity.HasIndex(e => e.ApplicationId);
            entity.HasIndex(e => new { e.Host, e.Path }).IsUnique();
                entity.HasIndex(e => new { e.ApplicationId, e.IsPrimary, e.Host });
            ...
            entity.Property(e => e.BasicAuthUsers).HasConversion<EncryptedStringConverter>();
        });
    }

    private void ConfigureComposeEnvironmentVariable(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<ComposeEnvironmentVariable>(entity =>
        {
            entity.HasKey(e => e.Id);
            entity.Property(e => e.Key).IsRequired().HasMaxLength(255);
            entity.Property(e => e.Value).IsRequired();
            ...
            entity.HasOne(e => e.Application)
                .WithMany(e => e.ComposeVariables)
                .HasForeignKey(e => e.ApplicationId)
                .OnDelete(DeleteBehavior.Cascade);

            // Encrypt secret values at rest
            entity.Property(e => e.Value).HasConversion<EncryptedStringConverter>();
        });
    }

    private void ConfigureDatabaseTemplate(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<DatabaseTemplate>(entity =>
        {
            entity.HasKey(e => e.Id);
            entity.ToTable("DatabaseTemplates");
            entity.Property(e => e.Name).IsRequired().HasMaxLength(100);
            entity.Property(e => e.DockerImage).IsRequired().HasMaxLength(200);
            entity.Property(e => e.Category).IsRequired().HasMaxLength(50);
            entity.Property(e => e.DefaultVolumePath).IsRequired().HasMaxLength(500);
